...
On Windows, set `LLVM_SYS_180_PREFIX=C:\llvm` to point at the LLVM 18 installation.
...
| `codegen/` | LLVM IR generation. Split: `statements.rs`, `expressions.rs`, `comparisons.rs`, `builtins.rs`, `simd.rs`, `simd_arithmetic.rs`, `simd_math.rs`, `simd_memory.rs`, `simd_masked.rs`, `structs.rs` |
...
| File | Lines |
|---|---|
| `src/ast/mod.rs` | **500** (at limit) |
| `src/main.rs` | 485 |
| `src/parser/expressions.rs` | 483 |
| `src/parser/statements.rs` | 461 |
| `src/codegen/simd.rs` | 449 |
| `src/codegen/simd_arithmetic.rs` | 435 |
