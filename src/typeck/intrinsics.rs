...
impl TypeChecker {
    ...
    fn dispatch_intrinsic(
        ...
        match name {
            ...
            "widen_u8_u16_hi" => Some(self.check_widen_u8_u16_hi(args, locals, span)),
            ...
            "wmul_u64" => Some(self.check_wmul_u64(args, locals, span)),
            ...
            "stream_store" => Some(self.check_stream_store(args, locals, span)),
            "fence_nt" => Some(self.check_fence_nt(args, span)),
            ...
            "lo128_i16x16" => Some(self.check_lo_extract(name, args, locals, span, Type::I16, 16)),
            "hi128_i16x16" => Some(self.check_hi_extract(name, args, locals, span, Type::I16, 16)),
            "lo128_u16x16" => Some(self.check_lo_extract(name, args, locals, span, Type::U16, 16)),
    ...
    // Transcendental f32-vector approximation checks (exp_poly, tanh, log,
    // sin/cos) live in `intrinsics_transcendental.rs`.
    // Prefetch checks live in `intrinsics_prefetch.rs`.
